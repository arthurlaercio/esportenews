				...
				<div class="clearfix main_content floatleft">
					...
					<div class="clearfix content">
						...
						<div class="clearfix post-meta">
							<p><span><i class="fa fa-user"></i> Admin</span> <span><i class="fa fa-clock-o"></i> 17 Maio 2016</span>
						</div>
						
						<p>O projeto consiste basicamente em um site de noticias relacionadas principalmente ao futebol brasileiro e seus campeonatos, tendo um pequeno espaço
                                                para alguns outros esportes. Podemos na administração inserir times, campeonatos e noticias relacionadas a eles.</p>
